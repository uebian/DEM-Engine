...
class CMakeExtension(Pybind11Extension):
    def __init__(self, name: str, sourcedir: str = "") -> None:
        ...
        super().__init__(
            name,
            sources=[],
            libraries=["libDEMERuntimeDataHelper"],
            include_dirs=["./src/DEM/", "./src/DEM/VariableTypes"],
            extra_objects=["./build"],
        )
...
class CMakeBuild(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        if "SP_DIR" in os.environ:
            cmake_args += [f"-DCMAKE_INSTALL_PREFIX={os.environ['SP_DIR']}/DEME"]
            cmake_args += [f"-DCMAKE_LIBRARY_OUTPUT_DIRECTORY={os.environ['SP_DIR']}/DEME"]
        ...
        if self.compiler.compiler_type != "msvc":
            ...
            cmake_args += ["-T v142,cuda=C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.8"]
...
setup(
    ...
    long_description="",
    ext_modules=[CMakeExtension("DEME.PyDEME_core")],
    packages=["DEME"],
    package_data={"DEME": ["*.so"]},
